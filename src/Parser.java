...
public class Parser implements Types
{
    ...
    public static Lexeme match(String type) throws IOException
    {
        ...
        {
            System.out.println("SYNTAX ERROR at Line " + Lexer.lineNumber + ": expected " + type + ", got " + Lexeme.type);
    ...
    public static Lexeme unary() throws IOException
    {
        ...
        if (check(STRING))
            ...
            return varDec();        //FIXME might need cons?
    ...
    public static void main(String args[]) throws IOException
    {
        lexInit(args[0]);
        current = i.lex();
        if (debug) Lexeme.display(current); // ONLY FOR TESTING
        program();
        match(ENDOFFILE);
